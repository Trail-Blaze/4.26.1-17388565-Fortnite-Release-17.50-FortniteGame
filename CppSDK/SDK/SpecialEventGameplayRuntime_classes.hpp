...
{
public:
	TArray<class FString>                         WhitelistedGameFeatures;                           // 0x02C8(0x0010)(Edit, ZeroConstructor, Config, DisableEditOnInstance, Protected, NativeAccessSpecifierProtected)
...
public:
	...
	uint8                                         Pad_371[0x27];                                     // 0x0371(0x0027)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_4DC[0x24];                                     // 0x04DC(0x0024)(Fixing Size After Last Property [ Dumper-7 ])
