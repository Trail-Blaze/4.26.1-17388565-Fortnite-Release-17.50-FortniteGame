...
public:
	...
	uint8                                         Pad_58B[0x65];                                     // 0x058B(0x0065)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	struct FNiagaraVMExecutableData               CachedScriptVM;                                    // 0x01C8(0x0118)(NativeAccessSpecifierPrivate)
	TArray<class UNiagaraParameterCollection*>    CachedParameterCollectionReferences;               // 0x02E0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	TArray<struct FNiagaraScriptDataInterfaceInfo> CachedDefaultDataInterfaces;                      // 0x02F0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
