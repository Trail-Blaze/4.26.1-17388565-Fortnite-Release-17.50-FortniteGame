...
DUMPER7_ASSERTS_FRewardCategoryTabData;
...
DUMPER7_ASSERTS_FRewardPreviewParams;
...
{
public:
	struct FVideoWidgetConfig                     SizzleVideo;                                       // 0x0000(0x0078)(NativeAccessSpecifierPublic)
	TArray<class FText>                           InfoModalEntries;                                  // 0x0078(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	class FText                                   NewStagesUnlockFinePrint;                          // 0x0088(0x0018)(NativeAccessSpecifierPublic)
};
...
public:
	...
	struct FAthenaSubscriptionProgressiveInfo     ProgressiveInfo;                                   // 0x0220(0x00A0)(NativeAccessSpecifierPublic)
	struct FAthenaSubscriptionPurchaseDetails     PurchaseSubscriptionDetails;                       // 0x02C0(0x00A8)(NativeAccessSpecifierPublic)
	class FText                                   SubscriptionDisclaimer;                            // 0x0368(0x0018)(NativeAccessSpecifierPublic)
	class FText                                   BlockedBenefitsNotice;                             // 0x0380(0x0018)(NativeAccessSpecifierPublic)
	struct FSubscriptionModals                    SubModals;                                         // 0x0398(0x0010)(NativeAccessSpecifierPublic)
};
