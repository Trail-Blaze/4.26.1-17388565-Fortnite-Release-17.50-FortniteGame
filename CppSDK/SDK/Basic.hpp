...
namespace Offsets
{
	constexpr int32 GObjects          = 0x09969D80;
	constexpr int32 AppendString      = 0x00E8B130;
	constexpr int32 GNames            = 0x09BAE9C0;
	constexpr int32 GWorld            = 0x09B53AC0;
	constexpr int32 ProcessEvent      = 0x00D4A264;
