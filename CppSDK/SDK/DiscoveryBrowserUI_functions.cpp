...
// Parameters:
// const struct FVector2D&                 PendingScrollAmounts                                   (Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)

void UFortActivityBrowserRow::HandleMobileScrollCompleted(const struct FVector2D& PendingScrollAmounts)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortActivityBrowserRow", "HandleMobileScrollCompleted");

	Params::FortActivityBrowserRow_HandleMobileScrollCompleted Parms{};

	Parms.PendingScrollAmounts = std::move(PendingScrollAmounts);
...
void UFortActivityBrowserRow::HandleUserScrolled(float CurrentOffset)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortActivityBrowserRow", "HandleUserScrolled");

	Params::FortActivityBrowserRow_HandleUserScrolled Parms{};
...
void UFortActivityBrowserRow::OnQueryStatusChanged(bool bIsActive)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortActivityBrowserRow", "OnQueryStatusChanged");

	Params::FortActivityBrowserRow_OnQueryStatusChanged Parms{};
...
void UFortActivityDetailsDisplay::OnDetailsUpdated()
{
	static class UFunction* Func = nullptr;
...
void UFortActivityDetailsDisplay::OnIsFavoriteChanged(bool bIsFavorite)
{
	static class UFunction* Func = nullptr;
...
// Function DiscoveryBrowserUI.FortActivityDetailsModal.OnLocalPlayerDemoted
// (Event, Protected, BlueprintEvent)

void UFortActivityDetailsModal::OnLocalPlayerDemoted()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortActivityDetailsModal", "OnLocalPlayerDemoted");

	UObject::ProcessEvent(Func, nullptr);
}


// Function DiscoveryBrowserUI.FortActivityDetailsModal.OnLocalPlayerPromotedToLeader
// (Event, Protected, BlueprintEvent)

void UFortActivityDetailsModal::OnLocalPlayerPromotedToLeader()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortActivityDetailsModal", "OnLocalPlayerPromotedToLeader");
...
void UFortActivityDetailsModal::OnPartySizeChanged(const int32 PartySize)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortActivityDetailsModal", "OnPartySizeChanged");

	Params::FortActivityDetailsModal_OnPartySizeChanged Parms{};
...
EFortInvalidActivityReason UFortActivityDetailsModal::GetInvalidActivityReason() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortActivityDetailsModal", "GetInvalidActivityReason");

	Params::FortActivityDetailsModal_GetInvalidActivityReason Parms{};
...
void UFortActivityDetailsSettingsWidget::OnSettingChanged(bool NewValue)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortActivityDetailsSettingsWidget", "OnSettingChanged");

	Params::FortActivityDetailsSettingsWidget_OnSettingChanged Parms{};
...
void UFortActivityListView::HandleMobileScrollCompleted(const struct FVector2D& PendingScrollAmounts)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortActivityListView", "HandleMobileScrollCompleted");

	Params::FortActivityListView_HandleMobileScrollCompleted Parms{};
...
// Function DiscoveryBrowserUI.FortActivityPlayerBrowserTile.HandleActivityUnSelected
// (Final, Native, Private)

void UFortActivityPlayerBrowserTile::HandleActivityUnSelected()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("FortActivityPlayerBrowserTile", "HandleActivityUnSelected");
